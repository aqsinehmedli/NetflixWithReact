...
const EmailInput = () => {
  return (
    <div className='flex items-center mx-auto mt-12 h-[60px] w-[580px]'>
        <input className='rounded-[4px] text-white w-full h-full px-4 gap-4 mr-2 bg-transparent border-[1px] border-zinc-400' placeholder='Enter your Email' type="text" />
        <button className='flex items-center min-h-full min-w-[230px] text-white font-semibold text-2xl pr-8 rounded-[4px] py-3 px-4 gap-4 bg-[rgb(229,9,20)] hover:bg-[#7E0309E5]'>Get Started
